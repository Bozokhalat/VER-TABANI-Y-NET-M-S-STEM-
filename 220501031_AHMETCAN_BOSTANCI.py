...
class PETROL_GEMİSİ():
    ...
    def veri_listele(self):
        ...
        self.sorgu.execute("SELECT * FROM {}".format(self.tablo_name))
        return self.sorgu.fetchall()
    def veri_ekle(self,gemi_ad,gemi_agirlik,yapim_yil,petrol_kapasite):
        self.sayac=int(satirokuyucu("veritabani41.db",1))
        self.seri_no="P"+str(self.sayac)
